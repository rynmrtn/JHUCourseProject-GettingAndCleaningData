...
groupedAndSummarizedMeasurements <- GroupAndSummarize(mergedDataWithActivityLabels)
write.table(groupedAndSummarizedMeasurements, "data/tidyData.txt", row.names = FALSE)
